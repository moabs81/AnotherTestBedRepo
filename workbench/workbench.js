...
export const AnchoringTopContent = connect(mapStateToProps, mapDispatchToProps)(TopMenu);
export const ScrollingBottomContent = connect(mapStateToProps,mapDispatchToProps)(BodyContent);
